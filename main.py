...
class MainWindow(QMainWindow):
    ...
    def _create_header(self):
        ...
        self.mini_btn.setStyleSheet(f"QPushButton{{border:2px solid transparent;background:{PRIMARY_COLOR};border-radius:16px;outline:none;}} QPushButton:hover{{background:#D6655E;}} QPushButton:focus{{border:2px solid #333333;}}")
    ...
    def _create_completed_section(self):
        ...
        completed_header.setStyleSheet(f"QPushButton{{text-align:left;padding:8px 5px;margin-top:10px;font-size:14px;font-weight:bold;color:{PRIMARY_COLOR};border:2px solid transparent;border-radius:4px;outline:none;}} QPushButton:hover{{background-color:#EEEEEE;}} QPushButton:focus{{border:2px solid {PRIMARY_COLOR};}}")
...
class MiniWindow(QMainWindow):
    ...
    def _create_header(self):
        ...
        back_btn.setStyleSheet(f"QPushButton{{border:2px solid transparent;background:{PRIMARY_COLOR};border-radius:14px;outline:none;}} QPushButton:hover{{background:#D6655E;}} QPushButton:focus{{border:2px solid #333333;}}")
