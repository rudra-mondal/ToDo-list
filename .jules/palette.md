...
## 2025-05-20 - Accessible Color Contrast for Text and Error States
**Learning:** Default CSS colors like 'red' or light grey '#888888' often fail WCAG AA contrast standards, making text unreadable for visually impaired users and error messages difficult to perceive.
**Action:** Always ensure custom text and UI element colors meet WCAG AA contrast standards. Avoid default CSS colors in favor of higher contrast alternatives, such as using '#CC0000' instead of 'red' and '#555555' instead of '#888888'.
